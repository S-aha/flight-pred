...
st.markdown("Upload your model, scaler, and dataset to predict flight prices.")
...
if model_file and scaler_file and dataset_file:
    try:
        ...
        # Dropdown options from uploaded dataset
        ...
        # Align the input features with the dataset
